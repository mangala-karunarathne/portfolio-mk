          ...
          {id == 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              <div className="flex flex-col gap-1 lg:gap-3 lg:mt-3 lg:pb-4">
                ...
                <span className="lg:py-7 lg:px-3 py-4 px-3  rounded-lg text-center bg-[#10132E]" />
              </div>
              <div className="flex flex-col gap-1 lg:gap-3 lg:mt-3 lg:pb-4">
                <span className="lg:py-7 py-4 first-letter:py-4 px-3 rounded-lg text-center bg-[#10132e] lg:mb-2 space-after mr-2" />
